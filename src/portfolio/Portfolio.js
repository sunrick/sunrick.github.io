...
class Portfolio extends Component {
  render() {
    return (
      <FluidContainer style={{marginTop: "3rem"}}>
        <PortfolioItem status="in development" title="sports fantasy game" subtitle="buy and sell results" labels="express.js + react native" description="Every user starts out with a certain amount of game currency. Each user can bet on an outcome of the match. Your profit is directly correlated with how other users bet on the game. User with highest amount of game currency at the end of the season wins."/>
