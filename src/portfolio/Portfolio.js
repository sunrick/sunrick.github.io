    ...
    return (
      <FluidMobileContainer style={{overflow: "auto", paddingTop: "3rem", backgroundColor: "#FFDC50", backgroundImage: `url(${lights})`, backgroundRepeat: "repeat"}}>
        ...
        <Box>
          ...
          <p> These are some of the ideas I've worked on that shine the brightest. </p>
          <p> </p>
        </Box>
        <PortfolioItem style={{paddingTop: "3rem"}} status="in development" title="sports fantasy game" subtitle="buy and sell results" labels="express.js + react native" description="A fun betting platform for match results. Compete against everyone or with friends in a league. User with most money at the end of the season wins."/>
