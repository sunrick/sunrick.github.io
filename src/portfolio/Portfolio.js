  ...
  render() {
    return (
      <FluidMobileContainer style={{overflow: "auto", paddingTop: "3rem"}}>
        ...
        <PortfolioItem status="in development" title="consulting platform" subtitle="hire experts for short term projects" labels="express.js + react.js" description="A platform that connects companies with experts. Companies can search for the experts they are looking for. Rate negotiation, scheduling, contracts and payment all handled through platform."/>
